## Esto es para hacer estilo_smooth.png resaltando del 2011 al 2017
...
png("estilo/gg_estilo150_smooth_resaltado.png", height = 1000, width = 1000)
ggplot(ggj, aes(x = fecha, y = valor)) +
    ...
    scale_x_continuous(breaks = seq(2006, 2023, by = 2)) +  # Set ticks every 2 units
    theme(
