## Esto es para hacer tema_smooth.png resaltando del 2011 al 2017
...
raw <- read.table("tema/50-doc-topics.csv", header = FALSE, sep = ",")
...
años <- as.character(datos2$año)
datos <- cbind(datos3, as.character(datos2$año))
...
png("tema/gg_tema_smooth_resaltado.png", height = 1000, width = 1000)
